 ...
 */
class MalsCartContentsWidget extends \WP_Widget
{
 ...
 * Cart add widget
 */
class MalsCartAddWidget extends \WP_Widget
{
    ...
    {
        parent::__construct(
            'cgit_mals_cart_add_widget',
            __('Add to Cart (Mal&rsquo;s)', 'text_domain')
        );
    }
...
add_action('widgets_init', function() {
    register_widget('Cgit\MalsCartContentsWidget');
    register_widget('Cgit\MalsCartAddWidget');
});
